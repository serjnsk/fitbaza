...
2. **Таймер на заблокированном экране** iOS и Android: звук + вибрация в фоне (TMR-2, TMR-3).
3. **Drag-and-drop длинной тренировки** в RN: 60fps на списке из 30+ упражнений.
4. **Парсер тренировочной нотации:** «EMOM 12», «10 rounds / 30 sec work / 15 sec rest» — прототип грамматики.
